...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            // OpenWhisper Phase 9.bridge: wire new backend modules to frontend.
            commands::openwhisper::get_voice_profile,
            commands::openwhisper::list_notes,
            commands::openwhisper::get_note,
            commands::openwhisper::create_note,
            commands::openwhisper::update_note,
            commands::openwhisper::delete_note,
            commands::openwhisper::list_snippets,
            commands::openwhisper::add_snippet,
            commands::openwhisper::update_snippet,
            commands::openwhisper::delete_snippet,
            commands::openwhisper::bulk_set_snippets,
            commands::openwhisper::list_dictionary_entries,
            commands::openwhisper::add_dictionary_entry,
            commands::openwhisper::update_dictionary_entry,
            commands::openwhisper::delete_dictionary_entry,
            commands::openwhisper::bulk_set_dictionary_entries,
            commands::openwhisper::list_transforms,
            commands::openwhisper::add_transform,
            commands::openwhisper::update_transform,
            commands::openwhisper::delete_transform,
            commands::openwhisper::preview_transform_prompt,
